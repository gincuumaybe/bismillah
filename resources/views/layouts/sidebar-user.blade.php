{{-- <aside
    class="fixed top-0 left-0 h-screen w-64 bg-gradient-to-br from-custom-blue to-custom-blue-light text-white overflow-auto font-poppins">
    <!-- Logo -->
    ...
    <nav class="mt-6 space-y-2 px-4">
        <a href="{{ route('user.dashboard') }}"
            class="flex items-center gap-2 px-3 py-2 rounded hover:bg-custom-blue-light {{ request()->routeIs('dashboard') ? 'bg-custom-blue-light' : '' }}">
            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.333 16.667V11.667h3.334v5H15.833V10h2.5L10 2.5 1.667 10h2.5v6.667H8.333Z"
                    fill="currentColor" />
            </svg>
            <span>Dashboard</span>
        </a>
        ...
        <a href="{{ route('laporan.index') }}"
            class="flex items-center gap-2 px-3 py-2 rounded hover:bg-custom-blue-light {{ request()->routeIs('laporan.*') ? 'bg-custom-blue-light' : '' }}">
            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('pembayaran.index') }}"
            class="flex items-center gap-2 px-3 py-2 rounded hover:bg-custom-blue-light {{ request()->routeIs('pembayaran.index*') ? 'bg-custom-blue-light' : '' }}">
            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                width="24" height="24" viewBox="0 0 24 24">
                <path fill="currentColor"
        ...
        <a href="{{ route('pembayaran.riwayat') }}"
            class="flex items-center gap-2 px-3 py-2 rounded hover:bg-custom-blue-light {{ request()->routeIs('pembayaran.riwayat*') ? 'bg-custom-blue-light' : '' }}">
            <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                width="24" height="24" viewBox="0 0 24 24">
                <path fill="currentColor"
    ...
    <div class="absolute bottom-0 w-full px-4 py-4 border-t border-white">
        <form method="POST" action="{{ route('logout') }}" id="logout-form">
            ...
            <button type="button" id="btn-logout"
                class="flex items-center w-full text-left px-3 py-2 rounded hover:bg-custom-blue-light">
...
<aside
    ...
    <nav class="mt-6 space-y-2 px-4">
        ...
        <!-- Check payment status before showing the "Pembayaran" link -->
